...
class NotiCell: UICollectionViewCell {
    ...
    func setupLayout() {
        ...
        separateLine.anchor(top: nil, left: stackView.leftAnchor, bottom: container.bottomAnchor, right: stackView.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: stackView.frame.width, height: 1)
    }
