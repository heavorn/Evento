...
//        logoImageView.translatesAutoresizingMaskIntoConstraints = false
        ...
        title.font = UIFont(name: "Noteworthy-Bold", size: 60)
    ...
    let sigupButton: UIButton = {
        ...
        attributeTitle.append(NSAttributedString(string: "Sign Up", attributes: [NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor.mainColor()]))
    ...
    let signinButton: UIButton = {
        ...
        button.backgroundColor = UIColor.rgb(red: 224, green: 83, blue: 83, alpha: 0.5)
    ...
    @objc func handleTextInputChange(){
        ...
        if isFormValid {
            ...
            signinButton.backgroundColor = UIColor.rgb(red: 224, green: 83, blue: 83, alpha: 0.5)
